...
REM   ASCII PUR, pas de pause -> h90_h180.txt
REM ==================================================================================
echo ============ 1. TESTS (frais + capture funding) ============ > h90_h180.txt
python -m pytest -q tests\test_hyperliquid_fees.py tests\test_snapshot_capture.py >> h90_h180.txt 2>&1

echo. >> h90_h180.txt
echo ============ 2. TRIAGE DES 91 TACHES ============ >> h90_h180.txt
python tools\trier_h90_h180.py >> h90_h180.txt 2>&1

echo. >> h90_h180.txt
echo ============ 3. SUITE COMPLETE (la verite) ============ >> h90_h180.txt
python -m pytest -q >> h90_h180.txt 2>&1

echo. >> h90_h180.txt
echo ============ 4. SECURITE ============ >> h90_h180.txt
python -m hl_observer safety-audit >> h90_h180.txt 2>&1
exit /b 0
