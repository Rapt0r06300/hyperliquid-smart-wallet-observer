...
REM   ASCII PUR, pas de pause -> check_cross_venue.txt
REM ==================================================================================
echo ================ 1. TESTS ================ > check_cross_venue.txt
python -m pytest -q tests\test_funding_cross_venue.py >> check_cross_venue.txt 2>&1
echo. >> check_cross_venue.txt
echo ================ 2. MESURE REELLE ================ >> check_cross_venue.txt
python tools\mesurer_funding_cross_venue.py >> check_cross_venue.txt 2>&1
echo. >> check_cross_venue.txt
echo ================ 3. SUITE COMPLETE (la verite) ================ >> check_cross_venue.txt
python -m pytest -q >> check_cross_venue.txt 2>&1
echo. >> check_cross_venue.txt
echo ================ 4. SECURITE ================ >> check_cross_venue.txt
python -m hl_observer safety-audit >> check_cross_venue.txt 2>&1
exit /b 0
