...
REM   ASCII PUR, pas de pause -> trois_pistes.txt
REM ==================================================================================
echo ============ 1. TESTS DES 3 MODULES ============ > trois_pistes.txt
python -m pytest -q tests\test_trois_pistes.py >> trois_pistes.txt 2>&1

echo. >> trois_pistes.txt
echo ============ 2. SUITE COMPLETE (la verite est sur Windows) ============ >> trois_pistes.txt
python -m pytest -q >> trois_pistes.txt 2>&1

echo. >> trois_pistes.txt
echo ============ 3. SECURITE ============ >> trois_pistes.txt
python -m hl_observer safety-audit >> trois_pistes.txt 2>&1
exit /b 0
