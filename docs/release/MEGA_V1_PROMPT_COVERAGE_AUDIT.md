...
| Recherche internet | DONE | docs/research | - | - | Maintenir les tests et la provenance; ne pas transformer en execution. |
...
| Pyramiding vs martingale | DONE | src/hl_observer/analysis | - | - | Maintenir les tests et la provenance; ne pas transformer en execution. |
...
| Dataset historique | DONE | src/hl_observer/data_sources | - | - | Maintenir les tests et la provenance; ne pas transformer en execution. |
...
| Wallet intelligence | DONE | src/hl_observer/analysis | - | - | Maintenir les tests et la provenance; ne pas transformer en execution. |
...
| Backtest | DONE | src/hl_observer/backtest | - | - | Maintenir les tests et la provenance; ne pas transformer en execution. |
...
| Pattern detector | DONE | src/hl_observer/analysis | - | - | Maintenir les tests et la provenance; ne pas transformer en execution. |
