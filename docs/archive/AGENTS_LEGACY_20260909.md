# Archive — ancien `AGENTS.md` racine

> Snapshot archivé le **2026-09-09** avant compactage du contexte automatique Codex.
> Ce document est **historique** et ne doit pas être chargé par défaut. En cas de divergence,
> le code/tests/gates du HEAD exact, `docs/CURRENT_STATE.md` et le `AGENTS.md` racine courant priment.
