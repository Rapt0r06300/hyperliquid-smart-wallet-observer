...
- **Event Intelligence:** USGS, NASA EONET, GDACS and GDELT are collected through bounded public GET-only adapters. Their V2 manifests carry the immutable 120-idea integration digest and the Copy-Vault/Lead-Lag/Cross-Venue/arbitrage bindings. Without an exact independent reference they remain `PARTIAL`, never artificially `SAFE`.
