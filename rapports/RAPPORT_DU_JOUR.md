...
Aucune fermeture sur la fenêtre — rien réalisé, rien perdu.
...
Aucune perte sur la fenêtre. (La boucle perte→leçon n'a rien à dire.)
...
_17 loi(s) : 14 réfutée(s), 2 limite(s), 1 confirmée(s). Détail complet : `docs/LOIS_MESUREES.md`. Une loi se rouvre avec une DONNÉE neuve, pas un argument neuf._
...
🔴 Réfutées (ne pas ré-ouvrir sans donnée neuve) : `cross_venue_leadlag_taker_no_edge`, `arb_ecart_fige`, `carry_plancher_domine`, `copy_global`, `copy_leader_contrarien`, `latence`, `market_making_spread`, `spread_prix_du_risque`, `funding_perp_perp`, `couverture_meme_actif`, `lead_lag`, `rendement_negatif_domine`, `hlp_benchmark`, `zscore_au_plancher`
