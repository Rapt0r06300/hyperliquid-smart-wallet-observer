# Rapport quotidien HyperSmart — 26/07/2026 23:08
...
- Cross-venue : **175.7 h / 72 h** (1097488 observations) — verdict aux barres pré-écrites, jamais avant.
- Usine à données replay (24 h) : **10140 candidats** · **283174 marks** — c'est le carburant du replay A/B.
...
_Calculé il y a 5.6 j (cadence : hebdo). Simulation sur candidats refusés enregistrés — pas une promesse._
...
- **Cross-venue : 72 h atteintes (176 h)** → lancer `python tools/mesurer_dispersion_venues.py` pour LE verdict (#178).
...
- Markout copy : 50.0% des fills mesures (29211/58471) — le pipeline nourrit la whitelist.
