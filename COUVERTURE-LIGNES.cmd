...
REM   ASCII PUR, pas de pause -> couverture_lignes.txt
REM ==================================================================================
echo DEBUT > couverture_lignes.txt
python tools\couverture_de_lignes.py >> couverture_lignes.txt 2>&1
echo FIN >> couverture_lignes.txt
exit /b 0
