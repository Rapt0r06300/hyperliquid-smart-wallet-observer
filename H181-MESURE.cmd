...
REM   ASCII PUR, pas de pause -> h181_mesure.txt
REM ==================================================================================
echo DEBUT > h181_mesure.txt
python tools\h181_malediction_du_vainqueur.py >> h181_mesure.txt 2>&1
echo FIN >> h181_mesure.txt
exit /b 0
