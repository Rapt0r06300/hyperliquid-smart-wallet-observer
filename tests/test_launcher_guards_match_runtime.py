...
def test_launcher_cmd_declares_simulation_guards():
    ...
    required = [
        ...
        "HYPERSMART_MIN_REDUCE_NOTIONAL_USDT=0",
        "HYPERSMART_SIMULATION_ALLOW_ADD_AS_ENTRY=0",
        "HYPERSMART_SIMULATION_MIN_EDGE_BPS=28",
        "HYPERSMART_SIMULATION_MIN_LIQUIDITY_SCORE=0.38",
        "HYPERSMART_SIMULATION_MAX_COPY_DEGRADATION_BPS=28",
        "HYPERSMART_SINGLE_WALLET_MIN_EDGE_BPS=55",
        ...
        "HYPERSMART_MAX_TOTAL_EXPOSURE_USDT=400",
        "HYPERSMART_SIMULATION_LEVERAGE=1",
        "HYPERSMART_MAX_OPEN_POSITIONS=12",
        "HYPERSMART_SLTP_TAKE_PROFIT_BPS=160",
        "HYPERSMART_SLTP_STOP_LOSS_BPS=120",
        "HYPERSMART_SLTP_TRAILING_BPS=0",
        "HYPERSMART_SLTP_TRAILING_ACTIVATION_BPS=0",
        "HYPERSMART_SLTP_STOP_MIN_HOLD_MS=120000",
        "HYPERSMART_SLTP_CATASTROPHIC_STOP_BPS=180",
    ]
