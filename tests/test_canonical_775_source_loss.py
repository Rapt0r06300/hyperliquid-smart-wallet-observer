...
def _manifest()->dict: return json.loads(MANIFEST_PATH.read_text(encoding="utf-8"))
...
def test_source_loss_terminal_est_honnete_et_progression_technique_non_faussee()->None:
    ...
    assert manifest["technical_completion_total"] == ROADMAP_TOTAL and manifest["technical_completion_done"] == 395
