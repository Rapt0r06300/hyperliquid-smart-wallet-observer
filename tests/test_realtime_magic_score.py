...
def test_realtime_magic_score_accepts_fresh_measurable_edge_for_local_simulation_only():
    ...
    assert score.edge_remaining_bps >= 8.0
...
def test_realtime_magic_score_rejects_stale_signal():
    score = score_realtime_copy_candidate(_input(signal_age_ms=601_000))
...
def test_realtime_magic_score_rejects_price_that_moved_too_far_against_copy():
    score = score_realtime_copy_candidate(_input(current_mid=101.0))
...
def test_realtime_magic_score_uses_crowding_as_risk_not_guarantee():
