...
REM   ASCII PUR, pas de pause -> archive_s3.txt
REM ==================================================================================
echo ============ TESTS ============ > archive_s3.txt
python -m pytest -q tests\test_archive_s3.py >> archive_s3.txt 2>&1
echo. >> archive_s3.txt
echo ============ SONDAGE (1 objet, cout chiffre) ============ >> archive_s3.txt
python tools\sonder_archive_s3.py --coin=BTC --jours=30 >> archive_s3.txt 2>&1
echo. >> archive_s3.txt
echo ============ TRIAGE H-46..H-89 ============ >> archive_s3.txt
python tools\trier_h46_h89.py >> archive_s3.txt 2>&1
exit /b 0
