...
def evaluer_et_journaliser(root: str | Path = ".", *, now_ms: int | None = None,
    ...
    # 06/08 — CARRY CROSS-VENUE : interrupteur RETIRE (flag MORT au registre : lu, defaut 0,
    # pose par AUCUN lanceur — et le scope fige Carry en DISABLED_BY_SCOPE). La capacite reste
    # dans hl_observer.funding.cross_venue_carry_paper (importee par experimental.runner et le
    # judge, couverte par tests) : la re-brancher = decision explicite + lanceur qui la pose.
