...
def campaign_from_replay(
    ...
    *,
    ...
    row: dict[str, Any] = {
        ...
        "oos": {
            "gross_pnl_usd": oos.get("gross_pnl_usd"),
            "fees_usd": oos.get("fees_usd"),
            "spread_cost_usd": oos.get("spread_cost_usd"),
            "slippage_cost_usd": oos.get("slippage_cost_usd"),
            "latency_cost_usd": oos.get("latency_cost_usd"),
            "net_pnl_usd": oos.get("net"),
            "sample_count": oos.get("closed_positions"),
            "trade_ids_count": oos.get("trade_ids_count"),
        ...
        "forward": {
            ...
            "fees_usd": forward.get("fees_usd"),
            "spread_cost_usd": forward.get("spread_cost_usd"),
            "slippage_cost_usd": forward.get("slippage_cost_usd"),
            "latency_cost_usd": forward.get("latency_cost_usd"),
            "net_pnl_usd": forward.get("net"),
            "sample_count": forward.get("closed_positions"),
            "trade_ids_count": forward.get("trade_ids_count"),
            "trade_ids_sha256": forward.get("trade_ids_sha256"),
            "duplicate_trade_ids": forward.get("duplicate_trade_ids"),
