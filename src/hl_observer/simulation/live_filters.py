...
# Defaults are deliberately conservative because the live paper engine pays
# spread/slippage/fees and the current logs show fee drag dominating gross edge.
DEFAULT_SIMULATION_MIN_EDGE_BPS = 28.0
DEFAULT_SIMULATION_MAX_SIGNAL_AGE_MS = 12_000
DEFAULT_SIMULATION_MIN_LIQUIDITY_SCORE = 0.38
DEFAULT_SIMULATION_MAX_COPY_DEGRADATION_BPS = 28.0
DEFAULT_SIMULATION_SINGLE_WALLET_MIN_EDGE_BPS = 55.0
DEFAULT_SIMULATION_ALLOW_ADD_AS_ENTRY = False
