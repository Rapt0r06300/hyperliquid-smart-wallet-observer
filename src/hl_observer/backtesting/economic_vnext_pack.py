...
from hl_observer.backtesting.cross_venue_certified import load_certified_atomic_series
...
def run_economic_vnext_pack(
    ...
    *,
    ...
    cross_series, cross_depth, cross_meta = load_certified_atomic_series(project_root)
