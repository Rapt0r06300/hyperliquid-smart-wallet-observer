...
REST_WEIGHT_LIMIT_PER_MINUTE = HYPERSMART_REST_WEIGHT_PER_MIN_PER_IP
SAFE_REST_WEIGHT_TARGET_PER_MINUTE = 840
INFO_LIGHT_WEIGHT = HYPERSMART_INFO_LIGHT_WEIGHT
INFO_DEFAULT_WEIGHT = HYPERSMART_INFO_DEFAULT_WEIGHT
INFO_TIME_RANGE_PAGE_LIMIT = HYPERSMART_INFO_TIME_RANGE_PAGE_LIMIT
INFO_EXTRA_ITEM_BUCKET_SIZE = HYPERSMART_INFO_EXTRA_ITEM_BUCKET_SIZE
EXPLORER_WEIGHT = HYPERSMART_EXPLORER_WEIGHT

WS_MAX_CONNECTIONS = HYPERSMART_WS_MAX_CONNECTIONS
WS_MAX_NEW_CONNECTIONS_PER_MINUTE = HYPERSMART_WS_MAX_NEW_CONNECTIONS_PER_MIN
WS_MAX_SUBSCRIPTIONS = HYPERSMART_WS_MAX_SUBSCRIPTIONS
WS_MAX_UNIQUE_USERS = HYPERSMART_WS_MAX_UNIQUE_USERS
WS_MAX_MESSAGES_PER_MINUTE = HYPERSMART_WS_MAX_MESSAGES_PER_MIN
...
def estimate_readonly_rest_weight(request: ReadOnlyBudgetRequest) -> int:
    ...
    extra_item_weight = hyperliquid_extra_item_weight(
        request.time_range_items_expected
    )
    return (
