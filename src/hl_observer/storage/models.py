...
class WalletActivitySummary(Base):
    ...
    fills_count: Mapped[int] = mapped_column(Integer, default=0)
    closed_pnl_count: Mapped[int] = mapped_column(Integer, default=0)
    ...
    pnl_total_usdc: Mapped[float | None] = mapped_column(Float)
    pnl_net_after_fees_usdc: Mapped[float | None] = mapped_column(Float)
    ...
    history_days: Mapped[float] = mapped_column(Float, default=0.0)
    regularity_score: Mapped[float] = mapped_column(Float, default=0.0)
    recent_activity_score: Mapped[float] = mapped_column(Float, default=0.0)
